        ...
        {job && (
          <>
            ...
            {(() => {
              ...
              return <StageTimeline stages={stagesData} runningStage={runningStage} />;
            })()}
            {job.status === "finished" && job.result?.output && (() => {
            ...
            {job.status === "finished" && job.result?.video_context && (
              <>
            ...
            {job.status === "finished" && job.payload?.mode === "audio" && job.result?.output && (
              <>
                <p className="stage-detail">
